...
Cypress.Commands.add("insereUsuarioComEmpregado", (usuario) => {
    cy.exec_sql(
        ...
        "insert into faixasalarial values (nextval('faixasalarial_sequence'), 'Júnior', null, (select id from cargo where nome = 'Auxiliar Departamento Pessoal' and id = '1'), null, '252510')",
        ...
        "insert into cargo_areaorganizacional values ((select id from cargo where nome = 'Auxiliar Departamento Pessoal' and id = '1'), (select id from areaorganizacional where nome = 'Gestao de Pessoas'))",
